  ...
  presets: [
    ...
    presetIcons({
      collections: {
        ...
        // Then install: deno add npm:@fortawesome/pro-regular-svg-icons npm:@fortawesome/pro-solid-svg-icons npm:@fortawesome/pro-thin-svg-icons npm:@fortawesome/pro-light-svg-icons npm:@fortawesome/pro-duotone-svg-icons
        // Then run: deno task convert-fa-pro
