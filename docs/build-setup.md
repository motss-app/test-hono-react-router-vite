...
For this repo, the Sentry build flow must avoid post-build JS rewriting on the client bundle. Legacy sourcemap upload is used so `unstable_subResourceIntegrity` stays valid.
